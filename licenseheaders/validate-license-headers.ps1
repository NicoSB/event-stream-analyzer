...
$root = "../"
$excludeFiles = "*\pom.xml"
$excludeFolders = "*\.idea\*","*\TARGET\*", "*\.git\*"
...
$javaLicenseHeader = $header.substring($header.IndexOf("/**"),$header.LastIndexOf("*/") - $header.IndexOf("/*") + 2)

Validate-File-Headers "*.java" $javaLicenseHeader
